...
<form class="form form-update" method="post" action="<?= $link->url("pizza.updateItem") ?>"
    ...
    <label><input name="description" type="text" placeholder="Description"
                  value="<?php if (isset($_GET['description'])) echo $_GET['description']; ?>"></label>

    <label><input name="cost" type="text" placeholder="Cost"
                  value="<?php if (isset($_GET['cost'])) echo $_GET['cost']; ?>"></label>
