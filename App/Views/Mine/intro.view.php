...
<div class="container">
    <div class="form-container sign-up">
        <form>
            ...
            <button class="btn-submit"><a href="<?= $link->url("shop.index") ?>">Sign up</a></button>
        </form>
    </div>
    ...
    <div class="form-container sign-in">
        <form>
            ...
            <button class="btn-submit"><a href="<?= $link->url("shop.index") ?>">Sign in</a></button>
        </form>
    </div>
    ...
    <div class="toggle-container">
        <div class="toggle">
            <div class="toggle-panel left-panel">
                ...
                <img src="public/images/pizza_sharing.png" alt="">
            </div>
...
<script src="script_intro.js"></script>
</body>
</html>
